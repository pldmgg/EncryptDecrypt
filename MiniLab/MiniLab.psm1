...
function Get-EncryptionCert {
    ...
    $CertificateFriendlyName = "Encryption"
    $Cert = Get-ChildItem -Path "Cert:\LocalMachine\My" | Where-Object {
        $_.FriendlyName -eq $CertificateFriendlyName
    } | Select-Object -First 1
    ...
    $CertInfo = [System.Security.Cryptography.X509Certificates.X509Certificate2]::new()
    if ($PSVersionTable.PSEdition -eq "Core") {
        $CertInfo.Import([System.IO.File]::ReadAllBytes("$ExportDirectory\$CommonName.cer"))
    }
    else {
        $CertInfo.Import("$ExportDirectory\$CommonName.cer")
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUWOGG79PbBFYTNMQA7di65s+g
# vKGgggn9MIIEJjCCAw6gAwIBAgITawAAAB/Nnq77QGja+wAAAAAAHzANBgkqhkiG
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNLFpfihtZv/EACv
# jT4Q23T52C5eMA0GCSqGSIb3DQEBAQUABIIBAFKgp7cz8e4YqcFfHEwBw+VevvGY
# 4q8539gUeqGz4bFGSbVCg7M2M1+2MiSTuvSS1x+j/dMiiTOHicTNqtnWC3csJMKo
# 5OQPKkk90HfmjeGvpdjkWWi1U+59MRU1AOys1mErJm6ZTeti9jFLD4qJnq+PQAOb
# YMZcO8ffkKtCou334n8bG22sy+y/AaQwPeuA7GaE+nLO/jbOkVsGMQqWWfcnGBS8
# TAQyZ+SniFCrwa8TuPhsYOS68QdoHU3gh4Lbr1wecHh6UUlFkUqvSpoRP56ZZh8e
# ZCsSVTwQRvcnUFKKiqfkNJPOdlbmedNAoyvZdiQavfkTuX9Msqe0V01SEQw=
